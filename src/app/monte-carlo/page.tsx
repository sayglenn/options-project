...
export default function Home() {
  ...
  const simulationsValue = watch("simulations", "");
        ...
        >
          ...
          <div className="relative mt-6">
            <input
              ...
              id="simulations"
              className={`${fieldClass} ${
                errors.simulations ? "border-red-500" : ""
              }`}
              {...register("simulations", {
                required: "Simulations is required",
                validate: (value) =>
                  parseFloat(value) >= 1 || "Simulations must be more than 0",
              })}
            ></input>
            <label
              htmlFor="simulations"
            ...
            {errors.simulations && (
              <p className={errorClass}>
                {errors.simulations.message as string}
              </p>
            )}
          </div>
          <button
